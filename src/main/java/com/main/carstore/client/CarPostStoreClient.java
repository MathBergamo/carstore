package com.main.carstore.client;
...
public class CarPostStoreClient {
    ...
    private final String USER_STORE_SERVICE_URI = "http://locahost:8080/user";
    private final String POSTS_STORE_SERVICE_URI = "http://locahost:8080/sales";

    @Autowired
    RestTemplate restTemplate; // Biblioteca Spring para comunicação entre micro-serviços
